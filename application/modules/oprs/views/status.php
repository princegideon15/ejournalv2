        ...
        <div class="container-fluid pt-3">
          ...
          <div class="card border border-dark">
            <div class="card-header">
              <i class="fas fa-bullhorn me-1"></i>Status Types
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-hover" id="status_types_table" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>Description</th>
                  ...
                  <tbody>
                    <?php $c = 1;foreach ($status as $row): ?>
                      <?php $status = ($row->status == 0) ? 'Disabled' : 'Enabled';?>
                    <tr>
                      <td><?php echo $c++; ?></td>
                      ...
                      <td>
                        ...
                        onclick="edit_status_type(<?php echo $row->id;?>)"><span class="fa fa-edit"></span> Edit</button>
                      </td>
                    </tr>
                    <?php endforeach;?>
                  </tbody>
