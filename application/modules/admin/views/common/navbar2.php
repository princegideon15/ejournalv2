        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark pt-5" id="sidenavAccordion">
            <div class="sb-sidenav-menu overflow-hidden">
                <div class="nav flex-column nav-pills pt-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <?php }?>
                    <button class="nav-link" id="v-pills-article-list-tab" data-bs-toggle="pill" data-bs-target="#v-pills-article-list" type="button" role="tab" aria-controls="v-pills-article-list" aria-selected="false"><i class="oi oi-eye me-2" title="oi-eye" aria-hidden="true"></i>View Articles<span class="ms-2 badge bg-primary mx-auto"><?php echo $art_count; ?></span></button>
                    <button class="nav-link" id="v-pills-journal-list-tab" data-bs-toggle="pill" data-bs-target="#v-pills-journal-list" type="button" role="tab" aria-controls="v-pills-journal-list" aria-selected="false"><i class="oi oi-eye me-2" title="oi-eye" aria-hidden="true"></i>View Journals<span class="ms-2 badge bg-primary ml-auto"><?php echo $jor_count; ?></span></button>
                    <button class="nav-link" id="v-pills-client-list-tab" data-bs-toggle="pill" data-bs-target="#v-pills-client-list" type="button" role="tab" aria-controls="v-pills-client-list" aria-selected="false"><i class="oi oi-eye me-2" title="oi-eye" aria-hidden="true"></i>View Clients<span class="ms-2 badge bg-primary ml-auto"><?php echo $client_count; ?></span></button>
                    <button class="nav-link" id="v-pills-viewers-list-tab" data-bs-toggle="pill" data-bs-target="#v-pills-viewers-list" type="button" role="tab" aria-controls="v-pills-viewers-list" aria-selected="false"><i class="oi oi-eye me-2" title="oi-eye" aria-hidden="true"></i>Abstract Hits<span class="ms-2 badge bg-primary ml-auto"><?php echo $hit_count; ?></span</button>
                    <button class="nav-link" id="v-pills-citees-list-tab" data-bs-toggle="pill" data-bs-target="#v-pills-citees-list" type="button" role="tab" aria-controls="v-pills-citees-list" aria-selected="false"><i class="oi oi-eye me-2" title="oi-eye" aria-hidden="true"></i>View Citees<span class="ms-2 badge bg-primary ml-auto"><?php echo $cite_count; ?></span></button>
                    <?php if ($this->session->userdata('_prv_add') == 1) {?>
