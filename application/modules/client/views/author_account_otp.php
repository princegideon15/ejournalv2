...
<div class="container-fluid mt-3 p-4">
    <div class="row">
        ...
        <div class="col col-lg-6 p-3">
            ...
            <?=form_open('client/signup/author_account_verify_otp/'.$this->session->userdata('otp_ref_code') ?? '', ['method' => 'post', 'id' => 'verifyOTPForm'])?>
                <div class="mb-3">
                ...
                <a type="button" class="btn main-btn w-50 mt-1 disabled" href="<?= $resend_link ? $resend_link : '#' ?>" id="resend_code">Resend Code</a>
            <?=form_close()?>
