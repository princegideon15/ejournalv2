...
<div class="container-fluid mt-3 p-4">
    <div class="row">
        ...
        <div class="col col-lg-6 p-3">
            <h2 class="mb-5">Create Author Account Verification</h2>
            <!-- Login -->
            ...
            <?=form_open('client/ejournal/author_account_verify_otp/'.$this->session->userdata('otp_ref_code') ?? '', ['method' => 'post', 'id' => 'verifyOTPForm'])?>
                <div class="mb-3">
                ...
                <button type="submit" class="btn main-btn w-50 mt-1 <?= $disabled ?>" onclick="disableOnSubmit(this, '#verifyOTPForm', 'verify')">Verify Code</button>
            <?=form_close()?>
