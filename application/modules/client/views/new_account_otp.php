        ...
        <div class="col col-lg-6 p-3">
            ...
            <?=form_open('client/signup/new_account_verify_otp/'.$this->session->userdata('otp_ref_code') ?? '', ['method' => 'post', 'id' => 'verifyOTPForm'])?>
                <div class="mb-3">
                    ...
                    <input type="otp" class="form-control form-control-lg text-center w-50 <?php if($this->session->flashdata('validation_errors')['otp']){ echo 'is-invalid';} ?>" id="otp" name="otp" placeholder="xxxxxx" maxlength="6">
