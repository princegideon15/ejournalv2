...
<div class="container-fluid mt-3 p-4">
    <div class="row">
        ...
        <div class="col col-lg-6 p-3">
            <h2 class="mb-5">Create Account Verification</h2>
            <!-- Login -->
            ...
            <?=form_open('client/login/new_account_verify_otp/'.$this->session->userdata('otp_ref_code') ?? '', ['method' => 'post', 'id' => 'verifyOTPForm'])?>
                <div class="mb-3">
