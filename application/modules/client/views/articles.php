          ...
          <span aria-hidden="true">&times;</span>
				...
				<div class="modal-body">
					<form id="form-client" autocomplete="off">
						...
						<div class="form-group">
							<label class="font-weight-bold" for="clt_age">Age<sup class="text-info font-weight-bold small" >(<i class="text-danger">*</i> Must be 20 years old and above)</sup></label>
...
echo '<option value=' . $c->country_id . '>' . $c->country_name . '</option>';?>
						...
						<div class="form-group">
							...
							<div id="verification_code_div" class="mt-1">
								<div class="btn btn-warning btn-block small font-weight-bold" id="send_verification_code" onclick="send_verification_code()" style="font-size:0.9em; width:100%;" title="Click this button to get the verification code emailed to you."><sup class="text-danger font-weight-bold">*</sup>Click this button to get the verification code emailed to you.</div>
							</div>
						</div>
						<div class="form-group">
							<label class="font-weight-bold" for="clt_vcode">Verification Code<span
									class="text-danger font-weight-bold">*</span></label>
							<input type="text" class="form-control font-weight-bold text-center" id="clt_vcode" name="clt_vcode"
...
<script>
 function send_verification_code(){
	let clt_email =  $("#clt_email").val();
		...
		$.post(url,{clt_email:clt_email}, function(data, status){
			console.log(status);
			console.log(data);
			if(status=="success"){
