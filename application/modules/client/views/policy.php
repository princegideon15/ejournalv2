    ...
    <div class="row pt-3">
		...
		<div class="col col-7 p-3">
					<div class="border p-5 mb-5 bg-white rounded">
						<div class="row mt-5">
							<div class="col">
                                <h3 class="mb-5 text-center">NRCP Research Journal Editorial Policy</h3>
                                
                                <p>The NRCP Research Journal is the official journal of the National Research Council of the Philippines. All articles published therein are refereed and evaluated by the Editorial Board and external reviewers on overall quality, correctness, originality, clarity of presentation, and contribution to scientific knowledge. It is open to all the members of the Council who wish to have their research published.
                                Both the author/s and the reviewers play significant roles in the efficiency and effectiveness of the editorial review process.
                                </p>
                                ...
                                All co-authors should have full knowledge and consent that the manuscript is submitted for publication in the NRCP Research Journal and all shall be kept informed of all correspondence about the submitted manuscript.
                                </p>
                                ...
                                <ul>
                                    ...
                                    <p>Upon arrival, each submitted manuscript undergoes a thorough evaluation by the Publication Team. This initial assessment encompasses a plagiarism check and aims to align the manuscript with the journal's objectives and standards. It evaluates the paper's importance, technical robustness, and originality (ensuring a similarity index below 10%). 
                                    The outcome of this evaluation determines if the manuscript proceeds to external review or requires revisions from the author/s. Authors are allotted two to four weeks for revisions, contingent upon the extent and urgency of the needed modifications.
                                    </p>
                                    ...
                                    <p>
                                    The refined manuscripts, following an initial assessment, will undergo double-blind refereeing, involving a minimum of two external reviewers. Submissions must include a completed and signed commitment form.</p> 
                                    <p>The external reviewers will have a month to assess the manuscripts, providing consolidated feedback and suggestions to the authors. Authors will then be afforded a period of two (2) weeks to a maximum of one month to revise and resubmit the manuscripts in response to the received feedback.
                                    </p>
                                </ul>
                                ...
                                <p>Once the camera-ready copy of the journal volume is prepared, it will be sent to the Web-Editor for online publication of the new journal issue.
                                </p>
                                ...
                                <p>The Editorial Board of the NRCP Research Journal shall remove a published article from the digital file as a result of the post-publication discovery of fraudulent research claims, plagiarism, or serious methodological errors that eluded detection during the quality assurance process.
                                </p>
                                ...
                                <p>The NRCP Research Journal is electronically made available and accessible through an online platform known as eJournal with URL <a href="https://researchjournal.nrcp.dost.gov.ph" target="_blank">https://researchjournal.nrcp.dost.gov.ph</a>.  The primary objective of this initiative is to digitally preserve the contents and ensure long-term and perpetual access to the information of the NRCP Research Journal. 
                                <p>
                                The NRCP Research Journal is indexed in C&E Adaptive Learning Solutions’ Philippine eJournals and all articles are made accessible globally through a single Web-based platform with URL <a href="https://ejournals.ph/index.p" target="_blank">https://ejournals.ph/index.p</a>.
                                </p>
                                ...
                                <ol>
                                    ...
                                    <li>The Editorial Board has the right to initiate investigation of any complaint related to infringement of copyright or other intellectual property rights, accuracy of data, libelous or otherwise materials. 
                                    </li>
                                ...
                                <p>
                                <a href="https://publicationethics.org/" target="_blank">https://publicationethics.org/</a>
                                </p>

                                <h5 class="h5 fw-bold">Publication Ethics and Malpractice</h5>
                                <p?>
                                The NRCP Research Journal is committed to uphold the highest standards of publication ethics and takes all possible measures against any publication malpractice.</p>
                                <p>
                                To prevent any actual or potential conflict of interest between and among the members of the Editorial Board, review personnel, and submitted manuscript, NRCP Research Journal is also committed to have an objective and fair double- blind peer- review of all submitted manuscripts for publication.</p>
                                <p>Reviewers and editors are expected to provide responsible, constructive, and prompt evaluation of submitted research papers based on the significance of their contribution and in the rigors of analysis and presentation. Publication of articles is free of charge. It can be accessed online through this link <a href="https://skms.nrcp.dost.gov.ph" target="_blank">https://skms.nrcp.dost.gov.ph</a>.
                                </p>
                                ...
                                <p>
                                Authors retain the rights to create print copies for personal scientific or academic use, reuse figures and tables in subsequent articles or works, and post a single PDF on their educational website post-publication.
                                Any potential disputes among authors and institutions represented shall be settled and managed by the authors and should not involve NRCP.</p> 
                                <p>Author contribution must be clearly stated at the end of the publication.
                                </p>
                                ...
                                <p>
                                The article shall state when and where the study was conducted. If the paper has been published as part of the proceedings of a convention, the paper submitted to the NRCP Research Journal must be substantially different from the one published in the said proceedings.</p>
                                <p>Plagiarism will be checked initially using Turnitin, a reliable detection application and by the reviewers. 
                                </p>
