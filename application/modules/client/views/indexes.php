				...
				<div class="tab-pane fade show active " id="home" role="tabpanel" aria-labelledby="home">
					<div class="jumbotron shadow p-5 mb-5 bg-white rounded ">
						...
						<div class="row">
							<div class="col">
								<!-- Latest Articles -->
								<h5 class="mt-5 mb-3"><?php echo count($articles) . ' indexed articles';?></h5>
									...
									<div class="media-body ml-2">
										<p class="mt-0">
											<h5 class="text-dark"
												...
												<br/>
												<small class="text-muted"><?php echo $row['year']; ?></small>
												<br/>
												<small class="text-muted"><a class="text-dark" href="<?php echo  base_url('/client/ejournal/get_articles/'.$row['vol'].'/'.$row['id_jor'].'');?>">Volume <?php echo $row['vol'] . ' ' . $issue; ?></a></small>
												<br/>
												<!-- <small class="text-muted">ISSN: <?php echo $row['issn']; ?></small> -->
